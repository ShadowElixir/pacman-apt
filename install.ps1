...
# Install the module
irm https://raw.githubusercontent.com/ShadowElixir/pacman-apt/main/pacman-apt.psm1 -outFile "C:\Users\%username%\Documents\Powershell\Modules\pacman-apt\pacman-apt.psm1"
